...
Primary key identify the column or set of columns that have values that uniquely identify a row in a table. 
These are important because they help identify the unique index for what we need.
